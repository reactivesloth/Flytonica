...
namespace RTG
{
    ...
    {
        [SerializeField]
        private Color _sphereBorderColor = DefaultSphereBorderColor;
        [SerializeField]
        private GizmoCap2DLookAndFeel[] _tickLookAndFeel = new GizmoCap2DLookAndFeel[6];
        [SerializeField]
        private Color _wireColor = DefaultWireColor;
        [SerializeField]
        private float _axialCircleCullAlphaScale = DefaultAxialCircleCullAlphaScale;
        [SerializeField]
        private float _tickCullAlphaScale = DefaultTickCullAlphaScale;

        public static Color DefaultSphereBorderColor { get { return ColorEx.FromByteValues(153, 232, 144, 255); } }
        public static Color DefaultWireColor { get { return ColorEx.FromByteValues(153, 232, 144, 255); } }
        public static float DefaultAxialCircleCullAlphaScale { get { return 0.3f; } }
        ...
        public Color SphereBorderColor { get { return _sphereBorderColor; } }
        public Color WireColor { get { return _wireColor; } }
        public float AxialCircleCullAlphaScale { get { return _axialCircleCullAlphaScale; } }
        ...
        public SphereColliderGizmoLookAndFeel()
        {
            ...
            SetSphereBorderColor(DefaultSphereBorderColor);
        ...
        {
            _axialCircleCullAlphaScale = Mathf.Clamp(scale, 0.0f, 1.0f);
        }
