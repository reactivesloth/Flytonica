...
namespace Code.Internal.Scenario
{
    ...
    public abstract class ScenarioBase : MonoBehaviour
    {
        ...
        protected virtual void AddStatistic()
        {
            ...
            resultBuilder.AddParameter("Падения из-за разрядки",
                _dischargeCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Столкновения с объектами",
                _collisionWithObjectsCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Потери сигнала из-за помех ЛЭП",
                _signalLossesPliCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Потери сигнала из-за РЭБ",
                _signalLossesRebCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Потери сигнала из-за препятствий",
                _signalLossesWallsCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Потери сигнала из-за отдаления",
                _signalLossesFarCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Столкновения с людьми",
                _collisionWithMensCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Столкновения с животными",
                _collisionWithAnimalsCount.ToString(CultureInfo.InvariantCulture));
            resultBuilder.AddParameter("Столкновения с птицами",
                _collisionWithBirdsCount.ToString(CultureInfo.InvariantCulture));
        }
